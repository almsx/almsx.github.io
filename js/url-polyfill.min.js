(function (t) {
	...
	var a = function () {
	  ...
	  e.toString = function () {
		var r = [];
		this.forEach(function (e, t) {
		  r.push(encodeURIComponent(t).replace(/%20/g, "+") + "=" + encodeURIComponent(e).replace(/%20/g, "+"));
		});
		return r.join("&");
	  };
	  t.URLSearchParams = a;
	...
	if (typeof f._fromString !== "function") {
	  Object.defineProperty(f, "_fromString", {enumerable: false, configurable: false, writable: false, value: function (e) {
		...
		for (var t = 0; t < n.length; t++) {
		  i = n[t].split("=");
		  this.append(decodeURIComponent(String(i[0]).replace(/\+/g, " ")), i.length > 1 ? decodeURIComponent(String(i[1]).replace(/\+/g, " ")) : "");
		}
	  }});
	}
  ...
  (function (u) {
	...
	var t = function () {
	  ...
	  Object.defineProperties(r, {toString: {get: function () {
		var e = this;
		return function () {
		  return e.href;
		};
		...
		return "";
	  }, set: function (e) {}, enumerable: true}});
	...
	if (u.location !== void 0 && !("origin" in u.location)) {
	  try {
		...
		setInterval(function () {
		  u.location.origin = u.location.protocol + "//" + u.location.hostname + (u.location.port ? ":" + u.location.port : "");
		}, 100);
	  }
	}
  }(typeof global !== "undefined" ? global : typeof window !== "undefined" ? window : typeof self !== "undefined" ? self : this));
